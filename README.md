...
TVアニメ・劇場アニメを制作スタジオ・監督・シリーズ構成・声優・放送クール・受賞歴・テーマから検索できるファンデータベースです。姉妹サイト [らのべDB](https://izenmi.github.io/ranobe-db/) のアニメ版として作成しました。**作品はシリーズ単位で1エントリ**として登録し、放送クール(年×季節)の年表で辿れるのが特徴です。
