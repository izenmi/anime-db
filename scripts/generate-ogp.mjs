...
const BADGES = [
  { label: "作品", value: counts.works, color: "#9d8ae6" },
  { label: "著者", value: counts.authors, color: "#f68fbe" },
  { label: "探偵", value: counts.detectives, color: "#8adcae" },
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .glow--1 { width: 520px; height: 520px; top: -180px; right: -140px; background: #ff86ad; }
...
<body>
  ...
  <div class="badge">ア</div>
  <h1>アニメDB</h1>
  <p class="tagline">TVアニメ・劇場アニメをスタジオ・監督・声優・放送クールから探せるデータベース</p>
  <div class="stats">
    ${BADGES.map(
